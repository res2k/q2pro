...
gl_bloom_sigma::
    Specifies sigma parameter of gaussian blur filter for the bloom effect.
    Default value is 6.

gl_bloom_radius::
    Specifies radius parameter of gaussian blur filter for the bloom effect.
    Default value is 16. Should not be higher than _3 * sigma_.
