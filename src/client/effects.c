...
void CL_MuzzleFlash(void)
{
    ...
    case MZ_BLASTER:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_BLAST, (const vec3_t) { 27.0f, 7.4f, -6.6f }, 0, 8.f, 0.f);
        break;
    ...
    case MZ_HYPERBLASTER:
        ...
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/hyprbf1a.wav"), volume, ATTN_NORM, 0);
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_BLAST, (const vec3_t) { 23.5f, 6.0f, -6.0f }, 0, 9.f, 0.f);
        break;
    case MZ_MACHINEGUN:
        VectorSet(dl->color, 1, 1, 0);
    ...
    case MZ_SSHOTGUN:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_SHOTG2, (const vec3_t) { 20.0f, 7.0f, -5.5f }, 0, 12.f, 0.f);
        break;
    case MZ_CHAINGUN1:
        ...
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound(soundname), volume, ATTN_NORM, 0);
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 0, 12.f, frand() * 360);
        break;
    case MZ_CHAINGUN2:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 0, 16.f, frand() * 360);
        break;
    case MZ_CHAINGUN3:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 0, 20.f, frand() * 360);
        break;
    case MZ_RAILGUN:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_RAIL, (const vec3_t) { 20.0f, 5.2f, -7.0f }, 0, 12.f, 0.f);
        break;
    case MZ_ROCKET:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_ROCKET, (const vec3_t) { 18.0f, 5.0f, -11.0f }, 0, 10.f, 0.f);
        break;
    case MZ_GRENADE:
        VectorSet(dl->color, 1, 0.5f, 0);
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_LAUNCH, (const vec3_t) { 18.0f, 6.0f, -6.5f }, 0, 9.f, 0.f);
        break;
    case MZ_BFG:
    ...
    case MZ_BFG2:
        VectorSet(dl->color, 0, 1, 0);
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_BFG, (const vec3_t) { 18.0f, 8.0f, -7.5f }, 0, 16.f, 0.f);
        break;
    ...
    case MZ_PHALANX2:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_ROCKET, (const vec3_t) { 18.0f, 10.0f, -6.0f }, 0, 9.0f, 0.f);
        break;
    case MZ_IONRIPPER:
        VectorSet(dl->color, 1, 0.5f, 0.5f);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/rippfire.wav"), volume, ATTN_NORM, 0);
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_BOOMER, (const vec3_t) { 18.0f, 3.8f, -4.5f }, 0, 15.0f, 0.f);
        break;
    ...
    case MZ_ETF_RIFLE_2:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_ETF_RIFLE, (const vec3_t) { 18.0f, mz.weapon == MZ_ETF_RIFLE ? 4.25f : 3.0f, -4.5f }, 0, 4.f, 0.f);
        break;
    case MZ_HEATBEAM:
        VectorSet(dl->color, 1, 1, 0);
        dl->die = cl.time + 100;
//      S_StartSound (NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/bfg__l1a.wav"), volume, ATTN_NORM, 0);
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_BEAMER, (const vec3_t) { 18.0f, 6.0f, -8.5f }, 0, 16.f, frand() * 360);
        break;
    case MZ_BLASTER2:
        VectorSet(dl->color, 0, 1, 0);
    ...
    case MZ_TRACKER:
        ...
        if (mz.entity == cl.clientNum + 1)
            CL_AddWeaponMuzzleFX(MFLASH_DIST, (const vec3_t) { 18.0f, 6.0f, -6.5f }, 0, 10.0f, 0.f);
        break;
    case MZ_NUKE1:
        VectorSet(dl->color, 1, 0, 0);
        dl->die = cl.time + 100;
